...
const mockInvoiceRepository = invoiceRepository as jest.Mocked<
...
describe('Invoice Service', () => {
  ...
  describe('createInvoice', () => {
    it('should create an invoice successfully', async () => {
      (mockInvoiceRepository.createInvoice as jest.Mock).mockResolvedValue(
        mockInvoice,
      );
    ...
    it('should handle error during invoice creation', async () => {
      ...
      (mockInvoiceRepository.createInvoice as jest.Mock).mockRejectedValue(
        error,
      );
  ...
  describe('getAllInvoices', () => {
    ...
    it('should handle error during fetching all invoices', async () => {
      ...
      (mockInvoiceRepository.getAllInvoices as jest.Mock).mockRejectedValue(
        error,
      );
  ...
  describe('getInvoiceById', () => {
    it('should return invoice when found', async () => {
      (mockInvoiceRepository.getInvoiceById as jest.Mock).mockResolvedValue(
        mockInvoice,
      );

      const result = await invoiceService.getInvoiceById('invoice-123');

      expect(mockInvoiceRepository.getInvoiceById).toHaveBeenCalledWith(
        'invoice-123',
      );
      expect(result).toEqual(mockInvoice);
    });
    ...
    it('should handle database error during fetch', async () => {
      const error = new Error('Database connection failed');
      (mockInvoiceRepository.getInvoiceById as jest.Mock).mockRejectedValue(
        error,
      );
  ...
  describe('updateInvoice', () => {
    it('should update invoice successfully when invoice exists', async () => {
      ...
      (mockInvoiceRepository.updateInvoice as jest.Mock).mockResolvedValue(
        mockUpdatedInvoice,
      );
      ...
      expect(mockInvoiceRepository.updateInvoice).toHaveBeenCalledWith(
        'invoice-123',
        mockUpdateInvoiceDto,
      );
    ...
    it('should handle error during invoice update', async () => {
      ...
      (mockInvoiceRepository.updateInvoice as jest.Mock).mockRejectedValue(
        error,
      );
  ...
  describe('deleteInvoice', () => {
    it('should delete invoice successfully when invoice exists', async () => {
      ...
      (mockInvoiceRepository.deleteInvoice as jest.Mock).mockResolvedValue(
        mockInvoice,
      );
      ...
      expect(mockInvoiceRepository.deleteInvoice).toHaveBeenCalledWith(
        'invoice-123',
      );
      expect(result).toEqual(mockInvoice);
    });
    ...
    it('should handle error during invoice deletion', async () => {
      ...
      (mockInvoiceRepository.deleteInvoice as jest.Mock).mockRejectedValue(
        error,
      );
